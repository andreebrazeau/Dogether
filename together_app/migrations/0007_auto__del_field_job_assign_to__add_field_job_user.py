...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.assign_to'
        db.delete_column('together_app_job', 'assign_to')

        # Adding field 'Job.user'
        db.add_column('together_app_job', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.assign_to'
        db.add_column('together_app_job', 'assign_to',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Job.user'
        db.delete_column('together_app_job', 'user_id')
